...
public class Administrador {
    ...
    private int restaurant_id_restaurant;
    ...
    public int getRestaurant_id_restaurant() {
        return restaurant_id_restaurant;
    }

    public void setRestaurant_id_restaurant(int restaurant_id_restaurant) {
        this.restaurant_id_restaurant = restaurant_id_restaurant;
    }

    @Override
    public String toString() {
        return "Administrador{" + "rut_adm=" + rut_adm + ", nombre_adm=" + nombre_adm + ", apat_adm=" + apat_adm + ", amat_adm=" + amat_adm + ", email_admin=" + email_admin + ", fono_admin=" + fono_admin + ", contrase\u00f1a1=" + contraseña1 + ", contrase\u00f1a2=" + contraseña2 + ", restaurant_id_restaurant=" + restaurant_id_restaurant + '}';
    }
